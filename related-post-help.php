...
<div class="wrap">
	<?php echo "<h2>".__(related_post_plugin_name.' Help')."</h2>";?>
    <br />
    ...
    if($related_post_customer_type=="free")
        {
            ...
            echo '<p>You are using <strong> '.$related_post_customer_type.' version  '.$related_post_version.'</strong> of '.related_post_plugin_name.', To get more feature you could try our premium version. ';
            
            echo '<a href="'.related_post_pro_url.'">'.related_post_pro_url.'</a></p>';
            
        }
    elseif($related_post_customer_type=="pro")
        {
    
            echo '<p>Thanks for using <strong> premium version  '.$related_post_version.'</strong> of <strong>'.related_post_plugin_name.'</strong> </p>';	
...
<?php
if($related_post_customer_type=="freeq")
	{
?>
	...
	<div class="pricing-table">
        ...
        <div class="column">
			...
			<div class="price"><a target="_blank" class="buy-now" href="<?php echo related_post_pro_url; ?>">$5 Buy Now</a></div>
            <div class="cell"><span class="green">Life time free update.</span></div> 
...
<div class="g-plusone" data-size="medium" data-href="<?php echo related_post_share_url; ?>"></div>

</td>
<td width="100px">
<iframe src="//www.facebook.com/plugins/like.php?href=<?php echo related_post_share_url; ?>&amp;width=100&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=21&amp;appId=743541755673761" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;" allowTransparency="true"></iframe>
...
<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo related_post_share_url; ?>" data-text="<?php echo related_post_plugin_name; ?>">Tweet</a>
